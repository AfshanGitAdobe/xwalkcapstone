...
## Environments
- Preview: https://main--xwalkcapstone--AfshanGitAdobe.aem.page/
- Live: https://main--xwalkcapstone--AfshanGitAdobe.aem.live/
...
1. Open the `xwalkcapstone` directory in your favorite IDE and start coding :)
